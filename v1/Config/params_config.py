...
parameters = {
    ...
    'CRITERIA_TO_SPLIT_TRAINING_DATA': {'year': 2019, 'month': 5},
    'MODEL_SELECTION': 'RF_CLF',  # 'PYTORCH_LISTNET', 'LIGHTGBM_LAMBDAMART', 'CATBOOST_YETIRANK', 'RF_CLF', 'WIN_ODDS'
    'MODEL_TARGET_RANK_LABEL': {'first': 1, 'second': 0, 'third': 0, 'others': 0},
    'HYPER_PARAMETERS': {
        ...
        'RF_CLF': {'CV_WAYS': 'RandomizedSearchCV',  # 'GridSearchCV' or 'RandomizedSearchCV'
